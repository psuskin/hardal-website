...
export const metadata: Metadata = {
  title: 'Datenschutzerklärung | Hardal Catering',
  description: 'Datenschutzerklärung von Hardal Catering - Informationen über unseren Umgang mit Ihren Daten.',
};
      ...
      <div className="container mx-auto px-4 md:px-6">
        ...
        <div className="mb-12 text-center">
          <h1 className="text-4xl md:text-5xl font-bold mb-4">
            Datenschutz<span className="text-first">erklärung</span>
          </h1>
        ...
        <div className="max-w-7xl mx-auto bg-white rounded-2xl shadow-sm p-6 md:p-10">
          <div className="prose max-w-none">
            ...
            <p className="leading-relaxed">
              ...
              Internetseiten der Köz Hamburg GmbH ist grundsätzlich ohne jede
            ...
            <p>
              ...
              Köz Hamburg GmbH geltenden landesspezifischen
            ...
            <p>
              Die Köz Hamburg GmbH hat als für die Verarbeitung Verantwortlicher
            ...
            <p>
              Die Datenschutzerklärung der Köz Hamburg GmbH beruht auf den
            ...
            <h3 className="text-xl font-semibold mt-4 mb-2">c) Verarbeitung</h3>
            <p>
            ...
            <h3 className="text-xl font-semibold mt-4 mb-2">e) Profiling</h3>
            <p>
            ...
            <h3 className="text-xl font-semibold mt-4 mb-2">i) Empfänger</h3>
            <p>
            ...
            <h3 className="text-xl font-semibold mt-4 mb-2">j) Dritter</h3>
            <p>
            ...
            <h3 className="text-xl font-semibold mt-4 mb-2">k) Einwilligung</h3>
            <p>
            ...
            <p>
              Tel.: +49 (0) 40/ 84708231
              <br />
              E-Mail: info@hardal-restaurant.de
              <br />
              Website: www.hardal-restaurant.de
            </p>

            <h2 className="text-2xl font-semibold mt-6 mb-4">3. Cookies</h2>
            <p>
              Die Internetseiten der Köz Hamburg GmbH verwenden Cookies. Cookies
            ...
            <p>
              Durch den Einsatz von Cookies kann die Köz Hamburg GmbH den
            ...
            <p>
              Die Internetseite der Köz Hamburg GmbH erfasst mit jedem Aufruf
              ...
              Informationen zieht die Köz Hamburg GmbH keine Rückschlüsse auf
              die betroffene Person. Diese Informationen werden vielmehr
              ...
              anonym erhobenen Daten und Informationen werden durch die Köz
              Hamburg GmbH daher einerseits statistisch und ferner mit dem Ziel
            ...
            <p>
              Die Internetseite der Köz Hamburg GmbH enthält aufgrund von
            ...
            <p>
              ...
              bei der Köz Hamburg GmbH gespeichert sind, veranlassen möchte,
              kann sie sich hierzu jederzeit an einen Mitarbeiter des für die
              Verarbeitung Verantwortlichen wenden. Der Mitarbeiter der Köz
              Hamburg GmbH wird veranlassen, dass dem Löschverlangen
              unverzüglich nachgekommen wird.
            </p>

            <p>
              Wurden die personenbezogenen Daten von der Köz Hamburg GmbH
              öffentlich gemacht und ist unser Unternehmen als Verantwortlicher
              gemäß Art. 17 Abs. 1 DS-GVO zur Löschung der personenbezogenen
              Daten verpflichtet, so trifft die Köz Hamburg GmbH unter
              ...
              der Köz Hamburg GmbH wird im Einzelfall das Notwendige
              veranlassen.
            </p>
            ...
            <p>
              ...
              Daten, die bei der Köz Hamburg GmbH gespeichert sind, verlangen
              ...
              Köz Hamburg GmbH wird die Einschränkung der Verarbeitung
              veranlassen.
            </p>
            ...
            <p>
              ...
              die betroffene Person jederzeit an einen Mitarbeiter der Köz
              Hamburg GmbH wenden.
            </p>
            ...
            <p>
              Die Köz Hamburg GmbH verarbeitet die personenbezogenen Daten im
            ...
            <p>
              Verarbeitet die Köz Hamburg GmbH personenbezogene Daten, um
              ...
              Person gegenüber der Köz Hamburg GmbH der Verarbeitung für Zwecke
              der Direktwerbung, so wird die Köz Hamburg GmbH die
            ...
            <p>
              ...
              Verarbeitung personenbezogener Daten, die bei der Köz Hamburg GmbH
            ...
            <p>
              ...
              Person direkt an jeden Mitarbeiter der Köz Hamburg GmbH oder einen
            ...
            <p>
              ...
              ausdrücklicher Einwilligung der betroffenen Person, trifft die Köz
              Hamburg GmbH angemessene Maßnahmen, um die Rechte und Freiheiten
            ...
            <p className="mt-8 text-sm text-gray-600">
              ...
              Augsburg tätig ist, in Kooperation mit dem Kölner IT- und
              Datenschutz Anwalt Christian Solmecke erstellt.
            </p>
          </div>
        </div>
      </div>
